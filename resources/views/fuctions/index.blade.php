    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            ...
            <div class="btn-group col-4" role="group" aria-label="Basic example">
                <a href="{{ route('fuctions.pdf') }}" class="btn btn-dark">PDF </a>
                <a href="/fuctionsXLS" class="btn btn-primary">xls </a>
                <a href="/fuctionsCSV" class="btn btn-dark">csv </a>
                <a href="/fuctionsxml" class="btn btn-primary">xml</a>
                <a href="{{ route('fuctions.grafica') }}" class="btn btn-dark">graficas</a>
            </div>
            <div class="col-sm-10">
                <h1>Funciones</h1>
            </div>
