    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="btn-group col-4" role="group" aria-label="Basic example">
                <a href="<?php echo e(route('entrances.pdf')); ?>" class="btn btn-dark">PDF </a>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cine1R\resources\views/entrances/index.blade.php ENDPATH**/ ?>