...
<?php $__env->startSection('content'); ?>
    ...
    <br><br>
    <div>
        <a href="<?php echo e(route('consumables.create')); ?>"><button class="btn-info">Agregar</button></a>
    </div>
    <br>
    <div class="btn-group col-4" role="group" aria-label="Basic example">
        <a href="<?php echo e(route('consumables.pdf')); ?>" class="btn btn-dark">PDF </a>
    ...
    <?php echo e($consumables->links()); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cine1R\resources\views/consumables/index.blade.php ENDPATH**/ ?>