<div>
    ...
    <div id="myCarousel" class="carousel slide carousel-fade col-12" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset('img/justice.jpg')); ?>" style="height: 768px">
                <img src="<?php echo e(asset('img/.jpg')); ?>" style="height: 768px">
                <div class="container">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(asset('img/vampire.jpg')); ?>" alt="" style="height: 768px">
                <div class="container">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(asset('img/world war z.jpg')); ?>" style="height: 768px">
                <div class="container">
    ...
    </div><?php /**PATH C:\laragon\www\cine1R\resources\views/layouts/carousel.blade.php ENDPATH**/ ?>